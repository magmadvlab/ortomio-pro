    ...
    <div className="space-y-6">
      ...
      {plants.length === 0 && (
        <div className="bg-white rounded-lg shadow-md p-32 text-center">
          ...
          <button
            onClick={() => setShowWizard(true)}
            className="bg-green-600 text-white px-6 py-3 min-h-[44px] touch-manipulation rounded-lg hover:bg-green-700 transition-colors flex items-center gap-3 mx-auto"
          >
            <Calculator size={20} />
      ...
      {showWizard && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-[95vw] sm:max-w-[95vw] sm:max-w-4xl w-full max-h-[95vh] sm:max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
            {/* Header */}
            <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 min-h-[44px] touch-manipulation flex items-center justify-between">
              <div className="flex items-center gap-3">
            ...
            <div className="p-4 sm:p-4 sm:p-6">
              ...
              <div className="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-200">
                ...
                <button
                  ...
                  className="px-6 py-2 min-h-[44px] touch-manipulation bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors flex items-center gap-3"
                >
                  <TreePine size={20} />
