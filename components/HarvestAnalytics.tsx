  ...
  if (!can('harvestAnalytics')) {
    return (
      <div className="bg-yellow-50 border border-yellow-full max-w-sm rounded-lg p-4 text-center">
        <p className="text-yellow-full max-w-sm">Analisi resa economica disponibile solo in versione Pro</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-full max-w-sm">
          <div className="flex items-center gap-3 mb-2">
            <Star size={18} className="text-yellow-full max-w-sm" />
            <span className="text-sm text-gray-600">Media Qualità</span>
          </div>
          <div className="text-xl md:text-2xl font-bold text-yellow-full max-w-sm">
