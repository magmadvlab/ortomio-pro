    ...
    <Card variant="default" className="p-6">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        {friendly.map((plant, idx) => (
          <div
            key={idx}
            className="flex flex-col items-center px-3 py-2 bg-ortomio-green-50 rounded-lg border border-ortomio-green-200"
          >
            <span className="text-xl mb-1">{plant.emoji}</span>
        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          ...
          <div className="flex flex-wrap gap-2">
            {avoid.map((plant, idx) => (
              <div
                key={idx}
                className="flex flex-col items-center px-3 py-2 bg-red-50 rounded-lg border border-red-200"
              >
                <span className="text-xl mb-1">{plant.emoji}</span>
