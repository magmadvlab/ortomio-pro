            ...
            <div className="max-w-md mx-auto space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 min-h-[44px] touch-manipulation border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-lg text-center"
                  placeholder="es. 2.5"
                />
              </div>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2 min-h-[44px] touch-manipulation border border-gray-300 rounded-lg hover:bg-gray-50"
                >
                  Indietro
                </button>
                <button
                  ...
                  className="flex-1 px-4 py-2 min-h-[44px] touch-manipulation bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Continua
                </button>
              </div>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-green-50 p-4 sm:p-4 sm:p-6 rounded-xl border border-blue-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 min-h-[44px] touch-manipulation text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                  >
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 min-h-[44px] touch-manipulation bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                >
                  {isGenerating ? (
                    <>
                      <Loader2 size={16} className="animate-spin" />
                    ...
                    <>
                      ...
                      Genera Piano AI
                      {(soilAnalysis || layoutSuggestion || varietyRecognition) && (
                        <span className="ml-1 px-2 py-0 min-h-[44px] touch-manipulation.5 bg-blue-500 text-white text-xs rounded-full">
                          +AI
                        </span>
                      )}
                    </>
      ...
      case 'results':
        ...
        return (
          <div className="space-y-6">
            ...
            {/* Timeline Preview */}
            <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-4 sm:p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-3">
                <Calendar size={20} />
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-2 min-h-[44px] touch-manipulation border border-gray-300 rounded-lg hover:bg-gray-50 flex items-center justify-center gap-3"
              >
                <Download size={16} />
                Scarica PDF
              </button>
              <button
                ...
                className="flex-1 px-4 py-2 min-h-[44px] touch-manipulation bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center justify-center gap-3"
              >
                <Eye size={16} />
                Vedi Dettagli
              </button>
              <button
                ...
                className="flex-1 px-4 py-2 min-h-[44px] touch-manipulation bg-green-600 text-white rounded-lg hover:bg-green-700 flex items-center justify-center gap-3"
              >
                <CheckCircle size={16} />
                Applica Piano
              </button>
