    ...
    <section className="bg-white px-6 py-20 sm:py-28">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid border-y border-ortomio-earth/30 md:grid-cols-2 md:divide-x md:divide-ortomio-earth/30">
          <article className="py-8 md:pr-10"><span className="font-mono text-xs text-ortomio-harvest">01 · REGOLE AGRONOMICHE</span><h3 className="mt-4 font-display text-2xl font-bold text-ortomio-green-900">Pianificazione agronomica</h3><p className="mt-3 leading-relaxed text-gray-700">Rotazioni, famiglie botaniche, periodi di semina e compatibilità costruiscono una base chiara, con la motivazione di ogni indicazione.</p></article>
          <article className="py-8 md:pl-10"><span className="font-mono text-xs text-ortomio-harvest">02 · CONFRONTO SCENARI</span><h3 className="mt-4 font-display text-2xl font-bold text-ortomio-green-900">Pianificazione assistita dall’AI</h3><p className="mt-3 leading-relaxed text-gray-700">Confronti periodi, scaglionamento, investimento e ricavo potenziale, considerando rischi legati a meteo, malattie e ritardi prima di decidere.</p></article>
        </div>
