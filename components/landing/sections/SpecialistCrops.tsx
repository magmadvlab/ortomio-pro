    ...
    <section id="colture" className="bg-ortomio-green-900 text-white">
      <div className="grid lg:grid-cols-[0.72fr_1.28fr]">
        ...
        <div className="px-6 py-20 sm:px-12 sm:py-28 lg:px-16">
          <Reveal className="max-w-3xl"><SectionHeader index="09" label="verticals" dark /><p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-ortomio-harvest">Indicatori e modelli dedicati per settore</p><h2 className="font-display text-3xl font-extrabold leading-tight sm:text-5xl">Un solo motore agronomico, modelli su misura per la tua coltura.</h2><p className="mt-6 text-lg leading-relaxed text-ortomio-green-100">Dalle orticole intensive ai vigneti di precisione, fino all’olivicoltura e ai frutteti. OrtoMio adatta algoritmi, indicatori fisici e modelli previsionali al linguaggio e alle esigenze reali del tuo settore.</p></Reveal>
