  ...
  return (
    <footer className="border-t border-white/10 bg-ortomio-green-900 px-6 py-10 text-ortomio-green-100">
      <div className="mx-auto grid max-w-6xl gap-8 text-sm sm:grid-cols-[1fr_auto] sm:items-end">
        <div><p className="font-display text-xl font-bold text-white">OrtoMio</p><p className="mt-2 max-w-md text-sm leading-relaxed">Per aziende agricole e consulenti agronomici che vogliono sapere sempre perché.</p></div>
