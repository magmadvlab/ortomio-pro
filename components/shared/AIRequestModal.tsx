  ...
  if (remaining < cost) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-4 sm:p-4 sm:p-6 max-w-[90vw] md:max-w-md max-h-[95vh] sm:max-h-[95vh] sm:max-h-[90vh] overflow-y-auto mx-4">
          <div className="text-center space-y-4">
            ...
            <div className="flex gap-3">
              <button
                onClick={onCancel}
                className="flex-1 px-4 py-2 min-h-[44px] touch-manipulation bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300"
              >
                Annulla
              </button>
              <button
      ...
      <div className="bg-white rounded-lg p-4 sm:p-4 sm:p-6 max-w-[90vw] md:max-w-md max-h-[95vh] sm:max-h-[95vh] sm:max-h-[90vh] overflow-y-auto mx-4">
        <div className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              onClick={onConfirm}
              className="flex-1 px-4 py-2 min-h-[44px] touch-manipulation bg-green-600 text-white rounded-lg hover:bg-green-700"
            >
              Conferma e procedi
            </button>
          </div>
