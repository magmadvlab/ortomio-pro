-- ============================================
-- GRUPPO 5: IRRIGATION SYSTEM
-- ============================================
-- Sistema di gestione zone irrigue con portate e calcolo minuti
-- 
-- Include:
-- - irrigation_systems
-- - irrigation_zones
...
CREATE TABLE IF NOT EXISTS irrigation_zones (
  ...
  valve_id UUID, -- Riferimento a smart_devices se presente (tabella da creare separatamente)
