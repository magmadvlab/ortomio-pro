...
BEGIN
  IF NOT EXISTS (
    ...
    IF EXISTS (
      ...
      -- garden_zones esiste, aggiungi con FK
    ...
    ELSE
      -- garden_zones non esiste, aggiungi solo colonna
      ALTER TABLE garden_tasks
...
-- Se garden_zones viene aggiunta successivamente, eseguire questo per aggiungere la FK:
-- ALTER TABLE garden_tasks
