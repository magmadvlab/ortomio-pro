module.exports = [
"[project]/services/geolocationService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/photoAnalysisService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const apiKey = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : process.env.GEMINI_API_KEY || ("TURBOPACK compile-time value", "AIzaSyDF1nX_pVSmFYWYNBkXziRMX-l9wybOvuA") || __TURBOPACK__import$2e$meta__?.env?.VITE_GEMINI_API_KEY;
const genAI = ("TURBOPACK compile-time truthy", 1) ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$genai$2f$dist$2f$node$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GoogleGenAI"]({
    apiKey: apiKey
...
"[project]/services/obstacleExtractor.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$photoAnalysisService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/photoAnalysisService.ts [app-ssr] (ecmascript)");
;
/**
...
async function extractObstaclesFrom360(photo360Base64, lat, lng) {
    try {
        ...
        const analysis = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$photoAnalysisService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["analyzePanoramic360"])(photo360Base64);
...
"[project]/services/visualSunInputConverter.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/plantMasterService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$varietyMappings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/varietyMappings.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$specializedCropMasterSheets$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/data/specializedCropMasterSheets.ts [app-ssr] (ecmascript) <locals>");
;
;
;
...
const getVarietyTags = (varietyName)=>{
    ...
    const mapping = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$varietyMappings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["varietyMappings"].find((v)=>v.varietyName.toLowerCase() === normalizedVariety || v.varietyName.toLowerCase().includes(normalizedVariety) || normalizedVariety.includes(v.varietyName.toLowerCase()));
    if (!mapping || !mapping.tags || mapping.tags.length === 0) {
        return [];
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$plantMasterSheets$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["behavioralTags"].filter((tag)=>mapping.tags.includes(tag.id));
};
...
const getAllBehavioralTags = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$plantMasterSheets$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["behavioralTags"];
};
const getAllMasterSheets = ()=>{
    return [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$plantMasterSheets$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["plantMasterSheets"],
        ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$specializedCropMasterSheets$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getAllSpecializedMasterSheets"])()
    ];
};
}),
"[project]/services/taskCalculationService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/seedInventoryService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/seedlingService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/seedlingBatchHelper.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$seedlingService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/seedlingService.ts [app-ssr] (ecmascript)");
;
function getReadyBatchesForPlant(plantName, batches, garden) {
    ...
    return batches.filter((batch)=>{
        ...
        const readyCheck = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$seedlingService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isReadyToTransplant"])(batch, garden);
...
"[project]/services/geographicMatchingService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$geolocationService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/geolocationService.ts [app-ssr] (ecmascript)");
;
/**
...
const getUserLocationProfile = async ()=>{
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$geolocationService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCurrentPositionWithRetry"])(2);
        if (!result.success || !result.latitude || !result.longitude) {
            // Fallback to default coordinates
            const defaultCoords = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$geolocationService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDefaultCoordinates"])();
...
"[project]/services/weatherService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/preciseSunCalculator.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/seasonalSunWindows.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$preciseSunCalculator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/preciseSunCalculator.ts [app-ssr] (ecmascript)");
;
 ...
 */ function aggregateMonths(lat, lng, obstacles, year, months) {
    ...
    for (const month of months){
        const monthly = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$preciseSunCalculator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateMonthlySunHours"])(lat, lng, year, month, obstacles);
        ...
        for (const day of sampleDays){
            const date = new Date(year, month - 1, day);
            const hours = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$preciseSunCalculator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateDailySunHours"])(lat, lng, date, obstacles);
            allHours.push(hours);
        }
    }
 ...
 */ function calculatePeakSunHoursForPeriod(lat, lng, obstacles, year, startMonth, endMonth) {
    ...
    for (const date of sampleDates){
        for(let hour = 6; hour < 18; hour += 0.5){
            const sunPos = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$preciseSunCalculator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateSunPosition"])(lat, lng, date, hour);
            if (sunPos.elevation > 0) {
...
"[project]/services/plantingWindowOptimizer.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function adjustPlantingDateForConditions(baseDate, soilType, altitudeMeters, plantType = 'standard') {
    ...
    if (altitudeMeters && altitudeMeters > 200) {
        const altitudeDelay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$altitudeUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateAltitudePlantingDelay"])(altitudeMeters, plantType);
        adjustedDate.setDate(adjustedDate.getDate() + altitudeDelay);
    }
    // 2. Applica correzione tipo terreno
    const soilDelay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$soilTemperatureUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateSoilWarmingDelay"])(soilType);
...
function adjustForPlantingMethod(window, method, plantId) {
    ...
    if (method === 'Seed') {
        ...
        if (plantId) {
            const plant = (0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$plantMasterSheets$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMasterSheetById"])(plantId);
            if (plant) {
...
"[project]/services/seasonalPlantSuggestions.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function suggestPlantsForGardenType(classification, windows, lat, lng, obstacles = [], year = new Date().getFullYear(), soilType, altitudeMeters) {
    const suggestions = [];
    const allPlants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$plantMasterSheets$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllMasterSheets"])();
    const giuLug = windows.find((w)=>w.period === 'Giu-Lug');
    const febMar = windows.find((w)=>w.period === 'Feb-Mar');
    const aprMag = windows.find((w)=>w.period === 'Apr-Mag');
    const agoSet = windows.find((w)=>w.period === 'Ago-Set');
    ...
    if (classification.type === 'Estivo' || classification.summerScore >= 0.7) {
        if (giuLug.avgHours >= 6) {
            ...
            estivePlants.forEach((plant)=>{
                ...
                const soilCompatibility = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$soilTemperatureUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSoilCompatibility"])(plant.commonName, soilType);
...
"[project]/services/historicalWeatherService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/fertilizerInventoryService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/soilStateService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/treatmentRegistryService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/deviceDetectionService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getDeviceInfo() {
    ...
    // Rileva piattaforma
    const userAgent = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : '';
    let platform = 'web';
...
"[project]/services/cloudSyncService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$deviceDetectionService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/deviceDetectionService.ts [app-ssr] (ecmascript)");
;
function detectPlatform() {
    const deviceInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$deviceDetectionService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDeviceInfo"])();
 ...
 */ async function syncToiCloud(data) {
    const { syncToiCloud: synciCloud } = await __turbopack_context__.A("[project]/services/icloudSyncService.ts [app-ssr] (ecmascript, async loader)");
    await synciCloud(data);
}
/**
 * Cerca backup iCloud disponibili
 */ async function detectiCloudBackups() {
    const { detectiCloudBackups: detectiCloud } = await __turbopack_context__.A("[project]/services/icloudSyncService.ts [app-ssr] (ecmascript, async loader)");
    return await detectiCloud();
}
/**
 * Ripristina da iCloud
 */ async function restoreFromiCloud(backup) {
    const { restoreFromiCloud: restoreiCloud } = await __turbopack_context__.A("[project]/services/icloudSyncService.ts [app-ssr] (ecmascript, async loader)");
 ...
 */ async function syncToGoogleDrive(data) {
    const { syncToGoogleDrive: syncDrive } = await __turbopack_context__.A("[project]/services/googleDriveSyncService.ts [app-ssr] (ecmascript, async loader)");
    await syncDrive(data);
}
/**
 * Cerca backup Google Drive disponibili
 */ async function detectGoogleDriveBackups() {
    const { detectGoogleDriveBackups: detectDrive } = await __turbopack_context__.A("[project]/services/googleDriveSyncService.ts [app-ssr] (ecmascript, async loader)");
    return await detectDrive();
}
/**
 * Ripristina da Google Drive
 */ async function restoreFromGoogleDrive(backup) {
    const { restoreFromGoogleDrive: restoreDrive } = await __turbopack_context__.A("[project]/services/googleDriveSyncService.ts [app-ssr] (ecmascript, async loader)");
...
"[project]/services/autoRestoreService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$deviceDetectionService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/deviceDetectionService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cloudSyncService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/cloudSyncService.ts [app-ssr] (ecmascript)");
...
async function attemptAutoRestore(storage) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$deviceDetectionService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isFirstLaunch"])()) {
        return {
            restored: false,
    ...
    try {
        ...
        if (existingGardens.length > 0) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$deviceDetectionService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["markLaunchComplete"])();
            return {
                restored: false,
    ...
    try {
        availableBackups = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cloudSyncService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["detectCloudBackups"])();
    } catch (error) {
        console.error('Error detecting cloud backups:', error);
        return {
            restored: false,
    ...
    try {
        const exportData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cloudSyncService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["restoreFromCloud"])(latestBackup);
        if (!exportData) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$deviceDetectionService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["markLaunchComplete"])();
            return {
                restored: false,
        ...
        const restoreResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["restoreFromExportData"])(exportData, storage);
...
async function restoreFromBackup(backup, storage) {
    try {
        const exportData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cloudSyncService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["restoreFromCloud"])(backup);
        if (!exportData) {
            return {
                success: false,
                gardensRestored: 0,
        ...
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["restoreFromExportData"])(exportData, storage);
    } catch (error) {
        return {
            success: false,
            gardensRestored: 0,
...
//# sourceMappingURL=services_593a8d99._.js.map