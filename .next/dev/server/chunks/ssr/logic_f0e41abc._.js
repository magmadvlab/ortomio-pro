module.exports = [
"[project]/logic/winterPreparationEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/lunarCalendar.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/vacationEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/plantMasterService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$taskCalculationService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/taskCalculationService.ts [app-ssr] (ecmascript)");
;
;
/**
...
const generateVacationPlan = (garden, tasks, startDate, endDate)=>{
    ...
    activeTasks.forEach((task)=>{
        const masterData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMasterSheet"])(task.plantName);
        if (!masterData) return;
        const daysAlive = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$taskCalculationService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateDaysActive"])(task);
...
"[project]/logic/seedlingTimelineEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/plantMasterService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/lunarCalendar.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/seasonalAdjustment.ts [app-ssr] (ecmascript)");
;
;
;
const calculateSeedlingTimeline = (batch, garden, weatherForecast)=>{
    const masterData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMasterSheet"])(batch.plantName);
    if (!masterData) {
 ...
 */ const calculateOptimalTransplantDate = (baseDate, batch, garden, weatherForecast)=>{
    ...
    const moonInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateMoonPhase"])(recommendedDate);
    const masterData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMasterSheet"])(batch.plantName);
    if (masterData) {
        const isIdeal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isIdealPhaseFor"])('transplant', masterData.nutrientCategory, recommendedDate);
        if (!isIdeal) {
            // Cerca prossima fase lunare ideale (entro 7 giorni)
            for(let i = 1; i <= 7; i++){
                const testDate = new Date(recommendedDate);
                testDate.setDate(testDate.getDate() + i);
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isIdealPhaseFor"])('transplant', masterData.nutrientCategory, testDate)) {
    ...
    // Verifica stagione
    const season = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSeasonForDate"])(recommendedDate, garden.coordinates?.latitude || 0);
...
"[project]/logic/fruitTreeEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/strawberryEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/exoticFruitEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/aromaticEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/raspberryEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/gardenLayoutEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/spaceCalculator.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$gardenLayoutEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/gardenLayoutEngine.ts [app-ssr] (ecmascript)");
;
/**
 ...
 */ function calculatePlantArea(plant, quantity) {
    ...
    const spacing = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$gardenLayoutEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseSpacing"])(spacingString);
...
"[project]/logic/nutrientEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/healthEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$treatments$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/treatments.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/seasonalAdjustment.ts [app-ssr] (ecmascript)");
;
;
const getCurrentSeason = (latitude = 0)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSeasonForDate"])(new Date(), latitude);
};
const getProductById = (id)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$treatments$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["protectionProducts"].find((p)=>p.id === id);
};
...
const calculateHealthStrategy = (plant, daysActive, season, latitude = 0, userProfile)=>{
    ...
    const availableProducts = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$treatments$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["protectionProducts"].filter((product)=>isProductAvailable(product, userProfile));
...
function getAvailableProducts(userProfile) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$treatments$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["protectionProducts"].filter((product)=>isProductAvailable(product, userProfile));
}
...
"[project]/logic/compostEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/lifecycleEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$taskCalculationService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/taskCalculationService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$nutrientEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/nutrientEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$healthEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/healthEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$weatherService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/weatherService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/lunarCalendar.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$altitudeUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/altitudeUtils.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$compostEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/compostEngine.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
 ...
 */ const generateSowingAdvice = (task, masterData)=>{
    ...
    const moonInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateMoonPhase"])(sowingDate);
    const moonCheck = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isIdealPhaseFor"])('sowing', masterData.nutrientCategory, sowingDate);
    const subTasks = [
    ...
    if (!moonCheck.ideal) {
        ...
        if (masterData.nutrientCategory === 'LEAFY' && moonCheck.daysUntilIdeal) {
            message += ` ⚠️ Attenzione: La luna è ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMoonPhaseName"])(sowingDate)}. Per evitare che ${task.plantName} monti a seme, sarebbe meglio aspettare ${moonCheck.daysUntilIdeal} giorni che la luna diventi Calante.`;
            adviceType = 'WARNING';
 ...
 */ const generateTransplantingAdvice = async (daysAlive, task, masterData, garden, nutrients, health)=>{
    ...
    if (garden.coordinates) {
        const weatherCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$weatherService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["checkTransplantConditions"])(garden.coordinates.latitude, garden.coordinates.longitude, masterData.transplanting.minTemp);
    ...
    if (garden.altitudeMeters && garden.altitudeMeters > 200) {
        ...
        const adjustedDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$altitudeUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adjustPlantingDates"])(new Date(), garden.altitudeMeters, plantType);
        if (delayDays > 0) {
    ...
    const moonCheck = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isIdealPhaseFor"])('transplant', masterData.nutrientCategory, transplantDate);
    const moonInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateMoonPhase"])(transplantDate);
    ...
    const humusSuggestion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$compostEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["suggestHumusAddition"])(garden, 6); // Assume compost maturo (6+ mesi)
 ...
 */ const generateProductionAdvice = (daysAlive, task, masterData, nutrients, health, currentDate, garden)=>{
    ...
    const moonCheck = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isIdealPhaseFor"])('harvest', masterData.nutrientCategory, harvestDate);
    const moonInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateMoonPhase"])(harvestDate);
    if (moonCheck.ideal) {
    ...
    if (daysUntilEnd <= 7 && daysUntilEnd >= 0) {
        ...
        const wasteAdvice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$compostEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["determineWasteDisposal"])(masterData, 'Unknown', false, false);
...
const checkLifecycleStatus = async (task, masterData, garden, currentDate = new Date())=>{
    ...
    const nutrients = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$nutrientEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateNutrientNeeds"])(masterData, daysAlive, garden.soilType);
    const health = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$healthEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateHealthStrategy"])(masterData, daysAlive);
...
const generateNextTreatmentTask = (completedTask, allTasks)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$healthEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scheduleNextTreatment"])(completedTask.id, completedTask.treatmentProductId, completedTask.date, completedTask.gardenId, completedTask.plantName, completedTask.variety);
};
}),
"[project]/logic/rainManager.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/oliveEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/vineEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/hydroponicEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/aquaponicEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/aeroponicEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/accessoriesEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/rotationOptimizer.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getPlantFamily = (plantName)=>{
    const masterData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMasterSheet"])(plantName);
...
"[project]/logic/solarClassificationHelper.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$seasonalSunWindows$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/seasonalSunWindows.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantingWindowOptimizer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/plantingWindowOptimizer.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$seasonalPlantSuggestions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/seasonalPlantSuggestions.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/plantMasterService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$seedlingBatchHelper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/seedlingBatchHelper.ts [app-ssr] (ecmascript)");
;
;
;
;
...
async function calculateGardenSolarClassification(garden, currentDate = new Date(), historicalWeather, seedlingBatches) {
    ...
    try {
        ...
        const windows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$seasonalSunWindows$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateSeasonalWindows"])(lat, lng, obstacles, year);
        // Classifica tipo di orto
        const classification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$seasonalSunWindows$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["classifyGardenType"])(windows);
        // Trova finestre di impianto ottimali (con aggiustamenti terreno, altitudine e temperatura)
        let plantingWindows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantingWindowOptimizer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findPlantingWindows"])(classification, windows, lat, lng, obstacles, year, garden.soilType, garden.altitudeMeters, historicalWeather || undefined);
        ...
        if (seedlingBatches && seedlingBatches.length > 0) {
            plantingWindows = plantingWindows.map((window)=>{
                ...
                const hasReadyBatch = window.recommendedPlants.some((plantName)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$seedlingBatchHelper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hasReadyBatchForPlant"])(plantName, seedlingBatches, garden));
                if (hasReadyBatch) {
                    ...
                    const adjustedWindow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantingWindowOptimizer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adjustForPlantingMethod"])(window, 'Seed', window.recommendedPlants[0] // Usa prima pianta per calcolo preciso
                    );
                    return {
                        ...window,
                        method: 'Seed',
            ...
            plantingWindows = plantingWindows.map((window)=>{
                const adjustedWindow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantingWindowOptimizer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adjustForPlantingMethod"])(window, 'Seed', window.recommendedPlants[0]);
                return {
                    ...window,
                    method: 'Seed',
                    adjustedStartDate: adjustedWindow.adjustedStartDate
        ...
        const optimizedSuggestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$seasonalPlantSuggestions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["suggestPlantsForGardenType"])(classification, windows, lat, lng, obstacles, year);
...
function getOptimizedPlantSuggestions(classification, windows, currentDate) {
    ...
    const year = currentDate.getFullYear();
    try {
        const suggestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$seasonalPlantSuggestions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["suggestPlantsForGardenType"])(classification, windows, lat, lng, obstacles, year);
...
"[project]/logic/annualPlannerEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/seasonalAdjustment.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$rotationOptimizer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/rotationOptimizer.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/plantMasterService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$solarClassificationHelper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/solarClassificationHelper.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$soilTemperatureUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/soilTemperatureUtils.ts [app-ssr] (ecmascript)");
;
;
;
;
...
const generateAnnualPlan = (garden, preferences, solarClassification)=>{
    ...
    const q1Season = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSeasonForDate"])(new Date(currentYear, 0, 15), latitude); // Gennaio
    const q2Season = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSeasonForDate"])(new Date(currentYear, 3, 15), latitude); // Aprile
    const q3Season = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSeasonForDate"])(new Date(currentYear, 6, 15), latitude); // Luglio
    const q4Season = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSeasonForDate"])(new Date(currentYear, 9, 15), latitude); // Ottobre
    const masterSheets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllMasterSheets"])();
    ...
    if (solarClassification) {
        ...
        availablePlants = availablePlants.filter((plantName)=>{
            const solarCompatibility = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$solarClassificationHelper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validatePlantCompatibility"])(plantName, solarClassification, mockWindows);
            return solarCompatibility.compatible;
        });
    }
    // Filtra per compatibilità terreno
    availablePlants = availablePlants.filter((plantName)=>{
        const soilCompatibility = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$soilTemperatureUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSoilCompatibility"])(plantName, garden.soilType);
 ...
 */ const generateQuarterPlan = (startMonth, endMonth, season, availablePlants, garden, solarClassification)=>{
    ...
    const seasonalPlants = availablePlants.filter((plantName)=>{
        const master = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllMasterSheets"])().find((p)=>p.commonName === plantName);
...
const calculateProjections = (quarters, garden)=>{
    ...
    for (const quarter of Object.values(quarters)){
        for (const planting of quarter.plantings){
            const master = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllMasterSheets"])().find((p)=>p.commonName === planting.plantName);
...
const optimizeRotations = (plan, garden)=>{
    const optimizedRotations = plan.rotations.map((rotation)=>{
        ...
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$rotationOptimizer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["optimizeBedRotation"])(rotation, availablePlants, plan.year);
...
const suggestSuccessions = (harvestDate, bed, currentPlan)=>{
    ...
    for (const month of nextMonths){
        const season = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSeasonForDate"])(new Date(new Date().getFullYear(), month - 1, 15), 0);
...
"[project]/logic/mechanicalWorkEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function calculateMechanicalWorkTasks(garden, currentDate = new Date(), tasks) {
    ...
    const sizeInSqM = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$areaConverter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["convertToSqMeters"])(garden.sizeSqMeters, garden.sizeUnit || 'sqm');
    ...
    if (!completedPlowing && (currentMonth >= 10 || currentMonth <= 2)) {
        ...
        if (garden.coordinates) {
            try {
                const weather = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$weatherService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getWeatherForecast"])(garden.coordinates.latitude, garden.coordinates.longitude);
...
"[project]/logic/treePruningEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function calculateTreePruningTasks(garden, currentDate = new Date(), tasks) {
    ...
    // Calcola fase lunare
    const moonInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateMoonPhase"])(currentDate);
    ...
    if (currentMonth === 3 || currentMonth === 4) {
        ...
        if (citrusTrees.length > 0) {
            const suggestedDate = new Date(currentYear, currentMonth - 1, 10);
            const moonInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateMoonPhase"])(suggestedDate);
...
"[project]/logic/calendarTimelineEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/taskSynchronizer.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/logic/fertilizerEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$fertilizers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/fertilizers.ts [app-ssr] (ecmascript)");
;
function calculateFertilizerDosage(plant, nutrientNeeds, soilType, fertilizer, areaSqm = 1) {
    ...
    if (fertilizer.incompatibilities && fertilizer.incompatibilities.length > 0) {
        warnings.push(`Non mescolare con: ${fertilizer.incompatibilities.map((id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$fertilizers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFertilizerById"])(id)?.name || id).join(', ')}`);
    }
...
function suggestFertilizerProduct(nutrientNeeds, soilType, applicationTiming, availableProducts) {
    const products = availableProducts || __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$fertilizers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["allFertilizers"];
...
"[project]/logic/soilTimingEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function calculateTemperaDate(garden, lastRainDate, lastRainAmount// mm
    ...
    const forecast = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$weatherService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getWeatherForecast"])(garden.coordinates.latitude, garden.coordinates.longitude);
...
"[project]/logic/tillageEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$soilTimingEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/soilTimingEngine.ts [app-ssr] (ecmascript)");
;
async function suggestTillageWork(garden, zoneId, soilState, plannedPlanting) {
    ...
    const temperaCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$soilTimingEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSoilInTempera"])(garden, {
    ...
    const optimalWindow = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$soilTimingEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getOptimalWorkWindow"])(garden, soilState?.lastRainDate || new Date(), soilState?.lastRainAmount || 0);
    // Genera istruzioni
...
async function calculateTemperaTiming(garden, lastRainDate, lastRainAmount) {
    ...
    const temperaDate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$soilTimingEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateTemperaDate"])(garden, lastRainDate, lastRainAmount);
    const check = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$soilTimingEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSoilInTempera"])(garden, {
        lastRainDate,
        lastRainAmount
    });
    return {
...
async function getOptimalWorkWindow(garden, soilState) {
    ...
    const window = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$soilTimingEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getOptimalWorkWindow"])(garden, soilState.lastRainDate, soilState.lastRainAmount || 0);
    return {
...
"[project]/logic/phytoEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$phytoproducts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/phytoproducts.ts [app-ssr] (ecmascript)");
;
async function suggestPhytoProduct(problem, plant, weatherForecast, userProfile) {
    ...
    if (isDisease) {
        availableProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$phytoproducts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPhytoProductsForDisease"])(problem);
    } else if (isPest) {
        availableProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$phytoproducts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPhytoProductsForPest"])(problem);
    } else {
        // Prova entrambi
        availableProducts = [
            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$phytoproducts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPhytoProductsForDisease"])(problem),
            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$phytoproducts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPhytoProductsForPest"])(problem)
        ];
    }
...
async function checkTreatmentTiming(product, weatherForecast, harvestDate) {
    ...
    if (daysUntilHarvest !== null && daysUntilHarvest < product.safetyInterval) {
        ...
        const alternatives = (0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$phytoproducts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProductsWithoutSafetyInterval"])().filter((p)=>p.category === product.category && p.allowedInOrganic === product.allowedInOrganic);
...
"[project]/logic/director.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$weatherService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/weatherService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lifecycleEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/lifecycleEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$nutrientEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/nutrientEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$healthEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/healthEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lunarCalendar$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/lunarCalendar.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/plantMasterService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$taskCalculationService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/taskCalculationService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$rainManager$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/rainManager.ts [app-ssr] (ecmascript)");
// Specialized crop engines (Pro Features)
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$strawberryEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/strawberryEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$fruitTreeEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/fruitTreeEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$aromaticEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/aromaticEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$oliveEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/oliveEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$vineEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/vineEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$exoticFruitEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/exoticFruitEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$raspberryEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/raspberryEngine.ts [app-ssr] (ecmascript)");
// Advanced growing systems engines (Pro Features)
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$hydroponicEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/hydroponicEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$aquaponicEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/aquaponicEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$aeroponicEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/aeroponicEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$accessoriesEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/accessoriesEngine.ts [app-ssr] (ecmascript)");
// Annual Planner integration
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$annualPlannerEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/annualPlannerEngine.ts [app-ssr] (ecmascript)");
// Nuovi engine per lavorazioni meccaniche, potatura alberi, timeline calendario
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$mechanicalWorkEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/mechanicalWorkEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$treePruningEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/treePruningEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$calendarTimelineEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/calendarTimelineEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$taskSynchronizer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/taskSynchronizer.ts [app-ssr] (ecmascript)");
// Solar Classification integration
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$solarClassificationHelper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/solarClassificationHelper.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$historicalWeatherService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/historicalWeatherService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/seasonalAdjustment.ts [app-ssr] (ecmascript)");
// Soil and Altitude utilities
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$soilTemperatureUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/soilTemperatureUtils.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$altitudeUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/altitudeUtils.ts [app-ssr] (ecmascript)");
// FERTILIZER, TILLAGE, PHYTO Engines
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$fertilizerEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/fertilizerEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$fertilizerInventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/fertilizerInventoryService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$tillageEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/tillageEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$soilStateService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/soilStateService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$phytoEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/logic/phytoEngine.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$treatmentRegistryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/treatmentRegistryService.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
 ...
 */ const checkWeatherUrgency = async (coordinates)=>{
    ...
    try {
        const forecast = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$weatherService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getWeatherForecast"])(coordinates.latitude, coordinates.longitude);
        if (!forecast) {
            return {
                alerts,
                warnings: warnings1
 ...
 */ function applySoilAndAltitudeAdjustments(garden, baseDate, plantType) {
    ...
    if (garden.altitudeMeters && garden.altitudeMeters > 200) {
        const altitudeDelay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$altitudeUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateAltitudePlantingDelay"])(garden.altitudeMeters, plantType || 'standard');
        adjustedDate.setDate(adjustedDate.getDate() + altitudeDelay);
    }
    // 2. Applica correzione tipo terreno (anticipo/ritardo riscaldamento)
    const soilDelay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$soilTemperatureUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateSoilWarmingDelay"])(garden.soilType);
...
const getDailyGardenPlan = async (garden, tasks, currentDate = new Date(), annualPlan, userProfile, seedlingBatches)=>{
    ...
    if (garden.coordinates) {
        try {
            ...
            try {
                historicalWeather = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$historicalWeatherService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllHistoricalWeather"])(garden.coordinates.latitude, garden.coordinates.longitude, currentDate.getFullYear());
            } catch (weatherError) {
            ...
            solarClassification = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$solarClassificationHelper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateGardenSolarClassification"])(garden, currentDate, historicalWeather, seedlingBatches);
        } catch (error) {
            console.error('Error calculating solar classification:', error);
    ...
    const activeTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$taskCalculationService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getActivePlants"])(tasks.filter((t)=>t.gardenId === garden.id));
        ...
        if (quarterPlan) {
            ...
            for (const harvest of recentHarvests){
                if (harvest.harvestDate && harvest.bed) {
                    const successions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$annualPlannerEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["suggestSuccessions"])(harvest.harvestDate, harvest.bed, annualPlan);
    ...
    if (solarClassification) {
        for (const task of activeTasks){
            ...
            const solarCompatibility = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$solarClassificationHelper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validatePlantCompatibility"])(task.plantName, solarClassification.classification, solarClassification.windows);
            ...
            // Validazione compatibilità terreno
            const soilCompatibility = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$soilTemperatureUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSoilCompatibility"])(task.plantName, garden.soilType);
            if (!soilCompatibility.compatible) {
                urgentAlerts.push({
                    type: 'SolarCompatibility',
        ...
        if (annualPlan && solarClassification) {
            ...
            if (quarterPlan) {
                const expectedPlantings = quarterPlan.plantings.filter((p)=>p.month === currentMonth);
                for (const expected of expectedPlantings){
                    const compatibility = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$solarClassificationHelper$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validatePlantCompatibility"])(expected.plantName, solarClassification.classification, solarClassification.windows);
    ...
    for (const task of activeTasks){
        ...
        const lifecycleAdvice = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$lifecycleEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["checkLifecycleStatus"])(task, masterData, garden, currentDate);
        if (lifecycleAdvice) {
                    ...
                    if (garden.coordinates && masterData.transplanting?.minTemp) {
                        try {
                            ...
                            if (forecast && forecast.tempMin !== undefined) {
                                const effectiveTemp = garden.altitudeMeters ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$altitudeUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateEffectiveTemperature"])(garden.altitudeMeters, forecast.tempMin) : forecast.tempMin;
                                const soilTemp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$soilTemperatureUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateSoilHeatingRate"])(garden.soilType, effectiveTemp);
                                const isReady = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$soilTemperatureUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSoilReadyForPlanting"])(garden.soilType, effectiveTemp, masterData.transplanting.minTemp);
                                if (!isReady) {
        ...
        if (!lifecycleAdvice) {
            ...
            const nutrientAdvice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$nutrientEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateNutrientNeeds"])(masterData, daysActive1, garden.soilType);
            if (nutrientAdvice.shouldFertilize) {
                nutrientTasks.push({
                    plantName: task.plantName,
                    element: nutrientAdvice.elementFocus,
                ...
                try {
                    const fertilizerRec = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$fertilizerEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["suggestFertilizerProduct"])(nutrientAdvice.elementFocus, garden.soilType, 'top_dressing');
                    if (fertilizerRec) {
                        // Aggiungi alert se scorte basse
                        const stockAlerts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$fertilizerInventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["checkLowStock"])(garden.id, (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSeasonForDate"])(currentDate, garden.coordinates?.latitude || 0));
            ...
            const season = garden.coordinates ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSeasonForDate"])(currentDate, garden.coordinates.latitude) : undefined;
            const latitude = garden.coordinates?.latitude || 0;
            const healthAdvice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$healthEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateHealthStrategy"])(masterData, daysActive1, season, latitude, userProfile);
            if (healthAdvice) {
                ...
                if (healthAdvice.actionType === 'Prevent' || healthAdvice.actionType === 'Treat') {
                    try {
                        const weatherForecast = garden.coordinates ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$weatherService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getWeatherForecast"])(garden.coordinates.latitude, garden.coordinates.longitude) : undefined;
                        const phytoRec = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$phytoEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["suggestPhytoProduct"])(healthAdvice.reason, masterData, weatherForecast, userProfile);
                        if (phytoRec) {
                            // Verifica timing con raccolta
                            const harvestTask = tasks.find((t)=>t.plantName === task.plantName && t.taskType === 'Harvest' && !t.completed);
                            if (harvestTask) {
                                const timingCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$phytoEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["checkTreatmentTiming"])(phytoRec.product, weatherForecast, new Date(harvestTask.date));
            ...
            if (daysActive1 > 20) {
                const season = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$seasonalAdjustment$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSeasonForDate"])(currentDate, garden.coordinates?.latitude || 0);
        ...
        if (forecast7Days.length > 0 && (task.taskType === 'Fertilize' || daysActive % 3 === 0)) {
            ...
            const irrigationAdjustment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$rainManager$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adjustIrrigationForRain"])(task, forecast7Days, garden);
    ...
    if (garden.coordinates) {
        try {
            weatherForecast = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$weatherService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getWeatherForecast"])(garden.coordinates.latitude, garden.coordinates.longitude);
        } catch (error) {
    ...
    for (const task of activeTasks){
        ...
        try {
            ...
            if (masterData.cropType === 'Strawberry') {
                ...
                const strawberryTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$strawberryEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateStrawberryTasks"])(strawberryCrop, currentDate);
            ...
            if (masterData.cropType === 'FruitTree') {
                ...
                const fruitTreeTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$fruitTreeEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateFruitTreeTasks"])(fruitTreeCrop, treeAge, currentDate);
            ...
            if (masterData.cropType === 'Aromatic' || masterData.cropType === 'Medicinal') {
                ...
                const aromaticTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$aromaticEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateAromaticTasks"])(aromaticCrop, currentDate);
            ...
            if (masterData.cropType === 'Olive') {
                ...
                const oliveTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$oliveEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateOliveTasks"])(oliveCrop, currentDate, weatherForecast);
            ...
            if (masterData.cropType === 'Vine') {
                ...
                const vineTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$vineEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateVineTasks"])(vineCrop, currentDate, weatherForecast);
            ...
            if (masterData.cropType === 'ExoticFruit') {
                ...
                const exoticTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$exoticFruitEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateExoticFruitTasks"])(exoticCrop, garden, currentDate);
            ...
            if (masterData.cropType === 'Raspberry') {
                ...
                const raspberryTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$raspberryEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateRaspberryTasks"])(raspberryCrop, currentDate);
    ...
    if (garden.gardenType && (garden.gardenType.startsWith('Hydroponic') || garden.gardenType === 'NFT' || garden.gardenType === 'DWC' || garden.gardenType === 'EbbFlow' || garden.gardenType === 'Drip' || garden.gardenType === 'Wick' || garden.gardenType === 'Kratky' || garden.gardenType === 'Hydroponic')) {
        try {
            ...
            const hydroponicTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$hydroponicEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateHydroponicTasks"])(garden, tasks, currentDate, hydroponicReadings);
    ...
    if (garden.gardenType === 'Aquaponic') {
        try {
            ...
            const aquaponicTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$aquaponicEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateAquaponicTasks"])(garden, tasks, currentDate, aquaponicReadings);
    ...
    if (garden.gardenType === 'Aeroponic') {
        try {
            const aeroponicTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$aeroponicEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateAeroponicTasks"])(garden, tasks, currentDate);
    ...
    for (const sowing of completedSowings){
        const sowingMasterData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$plantMasterService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMasterSheet"])(sowing.plantName);
        if (sowingMasterData) {
            const timeline = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$calendarTimelineEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateTimelineFromSowing"])(sowing, sowingMasterData, garden);
            ...
            for (const suggested of timeline.suggestedTasks){
                ...
                if (!existingTask) {
                    timelineSuggestedTasks.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$calendarTimelineEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["convertToGardenTask"])(suggested, sowing));
                }
            }
        }
    }
    ...
    try {
        const soilState = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$soilStateService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSoilState"])(garden.id, garden.id);
        if (soilState) {
            const temperaCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$tillageEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateTemperaTiming"])(garden, soilState.lastRainDate || new Date(), soilState.lastRainAmount || 0);
            if (temperaCheck.isTempera) {
                urgentAlerts.push({
                    type: 'Planning',
    ...
    try {
        const activeIntervals = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$treatmentRegistryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getActiveSafetyIntervals"])(garden.id);
    ...
    const mechanicalWorkSuggestions = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$mechanicalWorkEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateMechanicalWorkTasks"])(garden, currentDate, tasks);
    ...
    const treePruningSuggestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$treePruningEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateTreePruningTasks"])(garden, currentDate, tasks);
    ...
    const pendingSuggestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$logic$2f$taskSynchronizer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPendingSuggestions"])(tasks);
...
//# sourceMappingURL=logic_f0e41abc._.js.map