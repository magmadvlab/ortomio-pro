...
"[project]/packages/core/config/tiers.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/core/context/TierContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const TierContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(undefined);
const TIER_STORAGE_KEY = 'ortomio_tier';
const TierProvider = ({ children, defaultTier = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].FREE })=>{
    const [tier, setTierState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
        // LOCALE: Forza PRO_PROFESSIONAL in sviluppo locale
        const isLocalDev = ("TURBOPACK compile-time value", "undefined") !== 'undefined' && (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' || ("TURBOPACK compile-time value", "development") === 'development');
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        // Load from localStorage on mount (solo in produzione)
        try {
            const saved = localStorage.getItem(TIER_STORAGE_KEY);
            if (saved && (saved === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].FREE || saved === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].PRO || saved === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].PRO_CONSUMER || saved === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].PRO_PROFESSIONAL)) {
                return saved;
            }
        } catch (e) {
    ...
    const isConsumer = ()=>{
        return tier === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].PRO_CONSUMER || tier === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].PRO; // Legacy PRO is treated as Consumer
    };
    const isProfessional = ()=>{
        return tier === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].PRO_PROFESSIONAL;
    };
...
"[project]/services/storageService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/autoBackupService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ async function performBackup(storage, gardenId) {
    try {
        ...
        for (const garden of gardensToBackup){
            const exportBlob = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$exportService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["exportGardenData"])(garden.id, storage);
...
"[project]/packages/storage-local/LocalStorageProvider.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/storageService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/autoBackupService.ts [app-ssr] (ecmascript)");
;
;
class LocalStorageProvider {
    ...
    // Gardens
    async getGardens() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].getGardens();
    }
    async getGarden(id) {
    ...
    async createGarden(garden) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].saveGardens(gardens);
        // Trigger backup automatico (non bloccare se fallisce)
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAutoBackup"])(this, newGarden.id).catch((err)=>console.error('Error saving auto backup after createGarden:', err));
        return newGarden;
    }
    async updateGarden(id, updates) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].saveGardens(gardens);
        // Trigger backup automatico (non bloccare se fallisce)
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAutoBackup"])(this, id).catch((err)=>console.error('Error saving auto backup after updateGarden:', err));
        return gardens[index];
    }
    async deleteGarden(id) {
        const gardens = await this.getGardens();
        const filtered = gardens.filter((g)=>g.id !== id);
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].saveGardens(filtered);
    }
    // Tasks
    async getTasks(gardenId) {
        const tasks = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].getTasks();
        if (gardenId) {
    ...
    async createTask(task) {
        ...
        const tasks = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].getTasks();
        tasks.push(newTask);
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].saveTasks(tasks);
        // Trigger backup automatico (non bloccare se fallisce)
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAutoBackup"])(this, task.gardenId).catch((err)=>console.error('Error saving auto backup after createTask:', err));
        return newTask;
    }
    async updateTask(id, updates) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].saveTasks(tasks);
        // Trigger backup automatico (non bloccare se fallisce)
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAutoBackup"])(this, task.gardenId).catch((err)=>console.error('Error saving auto backup after updateTask:', err));
        return tasks[index];
    }
    async deleteTask(id) {
        const tasks = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].getTasks();
        const filtered = tasks.filter((t)=>t.id !== id);
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].saveTasks(filtered);
    }
    // Smart Devices
    async getDevices(gardenId) {
        const devices = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].getDevices();
        if (gardenId) {
    ...
    async createDevice(device) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].saveDevices(devices);
        return newDevice;
    }
    ...
    async deleteDevice(id) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageService"].saveDevices(filtered);
    }
    // Seed Inventory
    ...
    async createSeedPacket(packet) {
        ...
        // Trigger backup automatico (non bloccare se fallisce)
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAutoBackup"])(this, packet.gardenId).catch((err)=>console.error('Error saving auto backup after createSeedPacket:', err));
        return newPacket;
    }
    ...
    async createHarvestLog(log) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAutoBackup"])(this).catch((err)=>console.error('Error saving auto backup after createHarvestLog:', err));
        return newLog;
    }
    ...
    async createSeedlingBatch(batch) {
        ...
        // Trigger backup automatico (non bloccare se fallisce)
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAutoBackup"])(this, batch.gardenId).catch((err)=>console.error('Error saving auto backup after createSeedlingBatch:', err));
        return newBatch;
    }
    async updateSeedlingBatch(id, updates) {
        ...
        localStorage.setItem(this.STORAGE_KEYS.SEEDLING_BATCHES, JSON.stringify(batches));
        // Trigger backup automatico (non bloccare se fallisce)
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAutoBackup"])(this, batch.gardenId).catch((err)=>console.error('Error saving auto backup after updateSeedlingBatch:', err));
    ...
    saveGardenBeds(beds) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$autoBackupService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAutoBackup"])();
    }
...
"[project]/config/supabase.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getSupabaseClient = ()=>{
    ...
    const supabaseUrl = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : process.env.NEXT_PUBLIC_SUPABASE_URL;
    const supabaseAnonKey = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY;
    if (!supabaseUrl || !supabaseAnonKey) {
        console.warn('Supabase credentials not configured. Running in local mode.');
        return null;
    }
    try {
        supabaseClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$esm$2f$wrapper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])(supabaseUrl, supabaseAnonKey, {
            auth: {
                persistSession: true,
...
"[project]/packages/storage-cloud/SupabaseStorageProvider.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/config/supabase.ts [app-ssr] (ecmascript)");
;
class SupabaseStorageProvider {
    client;
    constructor(){
        this.client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSupabaseClient"])();
    }
    isAvailable() {
...
"[project]/packages/core/storage/factory.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$storage$2d$local$2f$LocalStorageProvider$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/storage-local/LocalStorageProvider.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$storage$2d$cloud$2f$SupabaseStorageProvider$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/storage-cloud/SupabaseStorageProvider.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/config/supabase.ts [app-ssr] (ecmascript)");
;
;
;
const createStorageProvider = (type = 'auto')=>{
    switch(type){
        case 'local':
            return new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$storage$2d$local$2f$LocalStorageProvider$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LocalStorageProvider"]();
        case 'cloud':
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSupabaseAvailable"])()) {
                console.warn('Supabase not available, falling back to localStorage');
                return new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$storage$2d$local$2f$LocalStorageProvider$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LocalStorageProvider"]();
            }
            return new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$storage$2d$cloud$2f$SupabaseStorageProvider$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SupabaseStorageProvider"]();
        case 'auto':
        default:
...
"[project]/packages/core/context/StorageContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$storage$2f$factory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/core/storage/factory.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/config/supabase.ts [app-ssr] (ecmascript)");
;
;
;
...
const StorageProvider = ({ children, initialProvider })=>{
    ...
    const [storageProvider, setStorageProvider] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>initialProvider || (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$storage$2f$factory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDefaultStorageProvider"])());
    const [isInitialized, setIsInitialized] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const checkAuthAndSwitch = async ()=>{
            try {
                ...
                const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSupabaseClient"])();
                ...
                if (isAuthenticated) {
                    ...
                    const supabaseProvider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$storage$2f$factory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSupabaseStorageProvider"])();
                    if (supabaseProvider) {
                        setStorageProvider(supabaseProvider);
                    } else {
                        // Fallback a LocalStorage se Supabase non disponibile
                        setStorageProvider((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$storage$2f$factory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLocalStorageProvider"])());
                    }
                } else {
...
"[project]/packages/core/hooks/useAuth.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/core/hooks/useTier.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$context$2f$TierContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/core/context/TierContext.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/core/config/tiers.ts [app-ssr] (ecmascript)");
;
;
;
const useTier = ()=>{
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$context$2f$TierContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TierContext"]);
    if (!context) {
        throw new Error('useTier must be used within a TierProvider');
    }
    const { tier, setTier, isConsumer: contextIsConsumer, isProfessional: contextIsProfessional } = context;
    const config = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTierConfig"])(tier);
    const can = (feature)=>{
    ...
    return {
        tier,
        config,
        isPro: tier === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].PRO || tier === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].PRO_CONSUMER || tier === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].PRO_PROFESSIONAL,
        isFree: tier === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].FREE,
...
"[project]/components/consumer/Sidebar.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ConsumerSidebar() {
    ...
    const { tier, can } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$hooks$2f$useTier$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTier"])();
...
"[project]/components/professional/Sidebar.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProfessionalSidebar() {
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePathname"])();
    const { tier } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$hooks$2f$useTier$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTier"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
        className: "w-64 bg-white border-r border-gray-200 min-h-screen p-4",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/components/shared/FreeSidebar.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/core/hooks/useStorage.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/globalSearchService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/shared/GlobalSearch.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$context$2f$StorageContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/core/context/StorageContext.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$globalSearchService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/globalSearchService.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
const GlobalSearch = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        searchTimeoutRef.current = setTimeout(async ()=>{
            try {
                const searchResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$globalSearchService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["searchAll"])(query, storageProvider);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            showResults && query.trim().length >= 2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: isSearching ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 188,
                    columnNumber: 13
                }, ("TURBOPACK compile-time value", void 0)) : results.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "p-2",
                    children: [
                        Object.entries(groupedResults).map(([type, typeResults])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mb-4",
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-1",
                                        children: typeResults.slice(0, 5).map((result)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            result.date && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        results.length > 10 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
"[project]/components/shared/AuthStatus.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/shared/InstallPrompt.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$context$2f$TierContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/core/context/TierContext.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$context$2f$StorageContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/core/context/StorageContext.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/core/hooks/useAuth.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$storage$2f$factory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/core/storage/factory.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$hooks$2f$useTier$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/core/hooks/useTier.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/core/config/tiers.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$consumer$2f$Sidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/consumer/Sidebar.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$professional$2f$Sidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/professional/Sidebar.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$FreeSidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/shared/FreeSidebar.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$GlobalSearch$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/shared/GlobalSearch.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$AuthStatus$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/shared/AuthStatus.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$InstallPrompt$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/shared/InstallPrompt.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function DashboardContent({ children }) {
    const { isProfessional, isConsumer } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$hooks$2f$useTier$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTier"])();
    const getSidebar = ()=>{
        if (isProfessional) {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$professional$2f$Sidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProfessionalSidebar"], {}, void 0, false, {
        ...
        if (isConsumer) {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$consumer$2f$Sidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ConsumerSidebar"], {}, void 0, false, {
                fileName: "[project]/app/(dashboard)/layout.tsx",
                lineNumber: 25,
                columnNumber: 14
            }, this);
        }
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$FreeSidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FreeSidebar"], {}, void 0, false, {
            fileName: "[project]/app/(dashboard)/layout.tsx",
            lineNumber: 27,
            columnNumber: 12
        }, this);
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$GlobalSearch$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                        fileName: "[project]/app/(dashboard)/layout.tsx",
                                        lineNumber: 41,
                                        columnNumber: 15
                                    }, this)
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "ml-4",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$AuthStatus$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                        fileName: "[project]/app/(dashboard)/layout.tsx",
                                        lineNumber: 44,
                                        columnNumber: 15
                                    }, this)
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$InstallPrompt$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                        fileName: "[project]/app/(dashboard)/layout.tsx",
                        lineNumber: 49,
                        columnNumber: 9
                    }, this)
...
function DashboardLayout({ children }) {
    const storageProvider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$storage$2f$factory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDefaultStorageProvider"])();
    // LOCALE: Sblocca tutte le feature impostando PRO_PROFESSIONAL di default
    // In produzione, ripristinare AppTier.FREE
    const isLocalDev = ("TURBOPACK compile-time value", "development") === 'development' || ("TURBOPACK compile-time value", "undefined") !== 'undefined' && window.location.hostname === 'localhost';
    const defaultTier = ("TURBOPACK compile-time truthy", 1) ? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$config$2f$tiers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AppTier"].PRO_PROFESSIONAL : "TURBOPACK unreachable";
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$context$2f$StorageContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StorageProvider"], {
            initialProvider: storageProvider,
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$core$2f$context$2f$TierContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TierProvider"], {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ed5dc5d9._.js.map