...
| O46 | M09 | **Scoperto 26/07/2026 durante la prova Semenzaio:** Production risponde `42703` perché mancano `seedling_batches.source`, `purchase_date` e `nursery_name`; migrazione `20260726180000_seedling_batch_sources.sql` preparata nella PR #68. | Migrazione applicata e registrata in Production; creazione semina interna e piantina acquistata entrambe verificate |
