...
- **Deploy readiness (certificazione 1.0):** `false` — il codice pubblicato non equivale alla certificazione: il probe read-only Production rileva ancora lo schema O39-O43 assente. Il verbale `M16_GO_NO_GO_2026-07-26.md` elenca tutte le evidenze remote mancanti.
...
| M15 | `[L]` codice in Production | O38-O43 confluiti tramite PR #62 e pubblicati dal merge `b99c53f`; O40 chiuso con modello unico PRO senza piani/limiti | Probe Production 26/07: colonne O39 e tabelle O41-O43 assenti; servono migrazioni e prove E2E su due aziende |
...
| O38 | M15 | **Codice pubblicato in Production 26/07/2026 tramite PR #62:** provisioning transazionale tramite API server e RPC; resta applicazione/prova staging | Cliente attivato senza intervento DB manuale |
| O39 | M15 | **Codice pubblicato in Production 26/07/2026 tramite PR #62:** API server, delivery tracciata e accettazione atomica; restano migrazione, provider configurato e prova E2E staging | Invito consegnato, accettato e auditato |
...
| O41 | M15 | **Codice pubblicato in Production 26/07/2026 tramite PR #62:** procedura amministrativa single-PRO con profilo fatturazione, fattura, pagamento, rinnovo e audit; restano migrazione e prova staging su due aziende | Ciclo economico documentato |
| O42 | M15 | **Codice pubblicato in Production 26/07/2026 tramite PR #62:** sospensione/riattivazione atomica, snapshot membership e chiavi, enforcement RLS e audit; restano migrazione e prova staging | Accessi e dati coerenti |
| O43 | M15 | **Codice pubblicato in Production 26/07/2026 tramite PR #62:** export con checksum, cancellazione, retention configurabile, legal hold, purge operativo e assistenza con consenso/scadenza/audit; restano migrazione e prova staging | Lifecycle di uscita verificato |
| O45 | M05 | ~~Eliminare gli 8 file orfani verificati~~ **Chiuso e pubblicato tramite PR #62 il 26/07/2026:** nuova verifica zero-importer, sostituti vivi confermati e rimossi soltanto `ProfessionalCalendar`, `EnhancedDashboard`, i due widget irrigazione, `OnboardingTier`, `VineyardPruningManager`, `MigrationWizard` e `cultivationOrchestrator.ts`. I quattro candidati non analizzati restano esclusi. | Tutti gli 8 file confermati rimossi, type-check/build/test verdi, nessun importer residuo |
