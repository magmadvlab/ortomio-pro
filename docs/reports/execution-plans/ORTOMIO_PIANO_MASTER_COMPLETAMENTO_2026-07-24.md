...
- **Deploy readiness (certificazione 1.0):** `false` — il deploy fisico di `main` non equivale alla certificazione. Il verbale `M16_GO_NO_GO_2026-07-26.md` elenca le evidenze remote ancora mancanti.
