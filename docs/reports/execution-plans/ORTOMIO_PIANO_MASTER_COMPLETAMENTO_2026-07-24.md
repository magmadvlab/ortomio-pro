...
- **Risultato locale:** registrazione, provisioning transazionale, inviti/delivery/accettazione, ruoli, modello unico PRO, procedura economica, rinnovo, sospensione/riattivazione, export, cancellazione, retention/legal hold e assistenza auditata sono implementati. Il 26/07/2026 O38-O43 sono stati chiusi localmente con API server autorizzate e RPC `service_role`; O40 e' stato chiuso per decisione prodotto esplicita single-PRO. Restano configurazione provider e prove E2E staging prima dello stato `[x]`.
- **Evidenza:** commit `19cb061` e `M15_COMMERCIAL_LIFECYCLE_GAPS_2026-07-24.md`.
- **Residuo:** applicazione migrazioni, provider inviti configurato e prove E2E O38-O43 su due aziende nello staging isolato.
...
| O43 | M15 | **Implementazione locale completata 26/07/2026:** export con checksum, cancellazione, retention configurabile, legal hold, purge operativo e assistenza con consenso/scadenza/audit; resta prova staging | Lifecycle di uscita verificato |
