...
| T01 | Trasversale | Inventariare e ridurre i 2.733 warning lint storici — **in corso 24/07/2026**: 2642 -> 2589 -> 2563 -> 2516 -> 2496 dopo 4 lotti (`docs/reports/T01_LINT_DEBT_BASELINE_2026-07-24.md`); lotto 1 `HomeDashboard.tsx` 49->0 (+ scoperto un pannello con dati finti, vedi nota M14 sopra), lotto 2 `ContinuousMonitoringDashboard.tsx` 26->0, lotto 3 `PlantLifecycleManager.tsx` 24->0 e `Planner.tsx` 19->0 (+ sistemati 2 bottoni stagionali morti nel Planner; scoperto poi il cluster "AI Planner" morto, ~6.100 righe/8 file, vedi nota M05 sopra — escluso da T01 su decisione dell'utente), lotto 4 `OrganizationManager.tsx` 11->0 e `ActivityRegistry.tsx` 9->0 dopo aver verificato la raggiungibilita' di ogni candidato prima di aprirlo | Baseline per categoria e trend registrati; zero warning release-blocking |
