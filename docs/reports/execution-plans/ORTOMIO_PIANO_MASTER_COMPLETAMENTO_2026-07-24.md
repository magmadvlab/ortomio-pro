...
| M05 | `[L]` censimento | Baseline iniziale di 203 occorrenze; gate nuove voci | 143 voci correnti assegnate a M11-M15 (`O05`) |
...
- **Verifiche correnti:** `npm run audit:release-debt` verde il 24/07/2026; 166 voci totali: 33 assegnate a M11, 29 a M12, 27 a M13, 48 a M14 e 6 a M15; 13 accettate; 10 isolate come sviluppo/laboratorio; zero assegnate a M09-M10.
...
| O05 | M05 | Riconciliare gli esiti delle 143 voci correnti trasferite a M11-M15 | Manifest finale senza voce `scheduled` irrisolta |
...
- audit debito release corrente: 166 voci, di cui 143 pianificate, 13 accettate e 10 isolate; nessuna voce release non classificata;
