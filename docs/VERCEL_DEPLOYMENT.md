...
5. Seleziona il repository `ortomio-ai`
...
3. Seleziona **"Production"**, **"Preview"**, e **"Development"** per ogni variabile

### Step 4: Deploy

1. Clicca **"Deploy"**
2. Attendi il build (circa 2-3 minuti)
3. Una volta completato, avrai un URL tipo: `ortomio-ai.vercel.app`
...
4. Vercel configurerà automaticamente HTTPS
...
3. Vai su **"Functions"** o **"Logs"** per vedere i log
...
2. **Usa Preview Deploys**: Testa su branch prima di merge su main
3. **Monitora Performance**: Usa Vercel Analytics per ottimizzare
4. **Backup**: Mantieni backup del database Supabase se usi Pro
5. **Versioning**: Usa tag Git per versioning delle release
6. **CI/CD**: Vercel fa deploy automatico ad ogni push (configurabile)
