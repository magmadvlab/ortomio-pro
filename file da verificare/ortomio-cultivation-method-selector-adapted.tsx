...
import { 
  ...
  Separator,
  Progress
} from '../ortomio-integration-adapter';
import { 
  Seed, 
  Sprout, 
  Clock, 
...
export default function CultivationMethodSelectorAdapted({
  plant,
  onSelect,
  ...
  // Calcoli per i tempi (usando dati OrtoMio esistenti)
  ...
  // Suggerimenti intelligenti basati su contesto OrtoMio
  ...
  return (
    <div className="space-y-6">
        ...
        <Card className="border-blue-200 bg-blue-50">
          <CardContent className="pt-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-blue-900">Suggerimento OrtoMio AI</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Confronto Dettagliato - Powered by OrtoMio AI
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
      ...
      {/* Informazioni contestuali OrtoMio */}
      {weatherConditions && (
