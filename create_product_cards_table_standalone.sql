-- Crea SOLO tabella product_cards per sistema trattamenti AI
-- Versione standalone senza dipendenze da altre tabelle

CREATE TABLE IF NOT EXISTS product_cards (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL, -- Rimuoviamo REFERENCES per ora
  garden_id UUID, -- Rimuoviamo REFERENCES per ora
  name TEXT NOT NULL,
