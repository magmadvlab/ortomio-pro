-- =====================================================
-- DEPLOY MULTI-TENANCY SYSTEM - DIRECT SQL
-- =====================================================
-- Questo script può essere copiato direttamente nel SQL Editor di Supabase
-- Contiene tutto il codice SQL necessario senza comandi psql
