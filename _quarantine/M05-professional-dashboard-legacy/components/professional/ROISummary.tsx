    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
          ...
          <p className="text-xl md:text-2xl font-bold text-gray-900">€{revenue.toFixed(2)}</p>
          {data?.previousMonth && (
        ...
        <div>
          ...
          <p className="text-xl md:text-2xl font-bold text-gray-900">€{costs.toFixed(2)}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-xl md:text-2xl font-bold text-gray-900">{yield_.toFixed(2)} kg</p>
        </div>
      </div>
    </div>
  )
