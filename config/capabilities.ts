...
export const CAPABILITIES: CapabilityDescriptor[] = [
  ...
  { id: 'ndvi', label: 'NDVI satellitare', description: 'Analisi satellitare con fallback dichiarato.', group: 'ANALYTICS E SMART', icon: 'satellite', route: '/app/ndvi', helpHref: '/docs/manual/05-ndvi-satellite', roles: ALL_ROLES, tiers: PRO, providers: ['sentinel'], providerRequirement: 'optional', maturity: 'simulation', targets: APP_TARGETS },
  ...
  { id: 'smart', label: 'Smart Hub', description: 'Dispositivi e automazioni con stato osservato.', group: 'ANALYTICS E SMART', icon: 'smart', route: '/app/smart', helpHref: '/docs/manual/14-smart-hub', roles: ALL_ROLES, tiers: PRO, providers: ['thingsboard'], providerRequirement: 'optional', maturity: 'simulation', targets: APP_TARGETS },
