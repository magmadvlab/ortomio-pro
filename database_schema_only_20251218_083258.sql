...
DROP POLICY IF EXISTS "Users can delpg_dump: dropping POLICY calendar_tasks Users can delete their own calendar tasks
...
ALTER TABLE IF EXISTS ONLY public.garden_correlations DROP CONSTRAINT IF EXpg_dump: dropping FK CONSTRAINT garden_beds garden_beds_structure_id_fkey
...
DROP INDEX IF EXISTS public.ipg_dump: dropping INDEX idx_treatment_register_garden
...
DROP INDEX IF EXISTS public.idx_agronompg_dump: dropping INDEX idx_advice_task_id
ists_user_id;
...
DROP TABLE IF EXISTS public.upg_dump: dropping TABLE treatment_register
ser_badges;
...
BEGIN
  ...
  WHERE garden_id = p_garden_id
    ...
    AND (p_end_date IS NULL OR harvest_date <= ppg_dump: creating FUNCTION "public.check_rotation_compliance(uuid, text)"
_end_date);
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM ai_credit_transactions 
                 WHERE user_id = NEW.id AND type = 'bonus'pg_dump: creating FUNCTION "public.list_all_users()"
...
CREATE TABLE public.agronomists (
    ...
    user_id uuid NOT NULL,
    name text NOT NULL,
    email text,pg_dump: creating TABLE "public.ai_credit_transactions"
...
CREATE TABLE public.crop_learning_events (
    ...
    user_id uuid NOT NULL,
    garden_id uuid,
    event_type tpg_dump: creating TABLE "public.crop_mechanical_works"
ext NOT NULL,
...
CREATE TABLE public.garden_beds (
    ...
    size_sq_meterpg_dump: creating TABLE "public.garden_correlations"
s numeric(5,2),
    sun_exposure text,
...
COMMENT ON COLUMN public.garden_patterns.custom_crop_id IS 'Riferimento pg_dump: creating TABLE "public.garden_season_analyses"
...
CREATE TABLE public.garden_tree_memories (
    ...
    alternance_pattern jsonb DEFAULT '{}'::jspg_dump: creating TABLE "public.garden_zone_memories"
onb,
...
--
-- TOC entry 362 (class 1259 pg_dump: creating TABLE "public.mechanical_work_register"
OID 33788)
...
CREATE TABLE public.user_badges (
    ...
    badge_name text Npg_dump: creating TABLE "public.weather_cache"
OT NULL,
...
-- Name: garden_beds garden_beds_pg_dump: creating CONSTRAINT "public.garden_correlations garden_correlations_pkey"
...
ALTER TABLE ONLY public.seed_inventory
    ADD CONSTRAINT seed_inventory_pkey PRIMARY KEY (id);pg_dump: creating CONSTRAINT "public.seedling_batches seedling_batches_pkey"
...
CREATE INDEX idx_calendar_tasks_user_date ON public.calendar_taskspg_dump: creating INDEX "public.idx_challenge_completions_challenge"
...
CREATE INDEX idx_custom_plans_gardenpg_dump: creating INDEX "public.idx_custom_plans_user_id"
...
-- Name: idx_learning_events_created_at; Type: INDEX; Schema: public; Owner: -pg_dump: creating INDEX "public.idx_learning_events_crop_id"
...
CREATE INDEX idx_seed_inventory_expiry_year ON public.seed_inventory USING btree (expiry_yepg_dump: creating INDEX "public.idx_seed_inventory_garden_id"
ar);
...
--
-- TOC entry 4132 (class 2620 OID 3pg_dump: creating TRIGGER "public.custom_crops update_custom_crops_timestamp"
4203)
...
-- Name: agronomist_consultations agronomist_consultations_garden_id_fkey; Type: FK CONSTRApg_dump: creating FK CONSTRAINT "public.agronomist_consultations agronomist_consultations_task_id_fkey"
...
ALTER TABLE ONLY public.crop_learning_events
    ADD CONSTRAINT crop_learning_events_user_id_fkey FOREIGNpg_dump: creating FK CONSTRAINT "public.custom_crops custom_crops_garden_id_fkey"
...
ALTER TABLE ONLY public.garden_patterns
    ADD CONSTRAINT garden_papg_dump: creating FK CONSTRAINT "public.garden_season_analyses garden_season_analyses_garden_id_fkey"
...
-- Name: mechanical_work_register mechanical_work_regispg_dump: creating FK CONSTRAINT "public.photo_logs photo_logs_garden_id_fkey"
...
CREATE pg_dump: creating POLICY "public.aquaponic_readings Users can access aquaponic readings in their gardens"
...
CREATE POLICY "Users can insert their own challenge completions" ON public.challenge_completions pg_dump: creating POLICY "public.weather_cache Users can insert weather cache"
...
CREATE POLICY "Users can only access harvests in their gardens" ON public.harvest_logs USING ((EXISTS ( SELECT 1
   FROM pupg_dump: creating POLICY "public.bed_planting_history Users can only access history in their beds"
blic.gardens
...
CREATE POLICY "Userpg_dump: creating POLICY "public.calendar_tasks Users can update their own calendar tasks"
...
ALTER TABLE public.agronpg_dump: creating ROW SECURITY "public.ai_credit_transactions"
...
ALTER TABLE public.harvest_logs ENABLE ROW LEVEL SECURITYpg_dump: creating ROW SECURITY "public.hydroponic_readings"
;
