              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Gestisci semi, piantine e alberelli
                  </p>
                </div>
              </div>
            ...
            <div className="p-6">
              {activeGarden ? (
                ...
                <div className="text-center py-8">
                  <p className="text-gray-600">Seleziona un giardino per gestire l'inventario semi</p>
                </div>
              )}
            </div>
          </div>
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-white p-4 rounded-lg shadow">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-600">Lotti Attivi</p>
            ...
            <div className="bg-white rounded-lg shadow">
              <div className="px-6 py-4 border-b border-gray-200">
                <h2 className="text-lg font-semibold text-gray-900">I Tuoi Lotti di Piantine</h2>
                <p className="text-sm text-gray-600 mt-1">
                  Lotti da semi propri e piantine acquistate da vivaio
                </p>
              </div>
              ...
              <div className="p-6">
                {batches.length > 0 ? (
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-gray-500">
                                  {batch.source === 'home' ? '🏠 Da semi propri' : '🏪 Da vivaio'}
                                </p>
                              </div>
                            </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Nessun lotto attivo</h3>
                    <p className="text-gray-600 mb-4">
                      {shouldCreate 
                        ? `Perfetto! Stai per creare un lotto per ${plantName}` 
                        : 'Inizia creando il tuo primo lotto di piantine'
                      }
                    </p>
                    {!shouldCreate && (
                      <button 
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-6">
              {activeGarden ? (
                ...
                <div className="text-center py-8">
                  <p className="text-gray-600">Seleziona un giardino per gestire gli alberelli</p>
                </div>
              )}
            </div>
          </div>
      ...
      {showCreateForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold mb-4">Crea Nuovo Lotto</h3>
