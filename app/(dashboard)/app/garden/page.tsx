...
function GardenContent() {
  ...
  const handleTabChange = (tab: 'timeline' | 'calendar' | 'plants' | 'harvest' | 'structure' | 'registry' | 'traceability') => {
  ...
  return (
    <GardenView
      garden={garden}
      tasks={tasks}
      activeTab={activeTab as 'timeline' | 'calendar' | 'plants' | 'harvest' | 'structure' | 'registry' | 'traceability'}
