...
/**
 * POST /api/garden/sun-exposure/seasonal-windows
 * Calcola finestre stagionali per un giardino
 */
export async function POST(request: NextRequest) {
  try {
    ...
    if (obstaclesError) {
      console.error('Seasonal windows obstacle read error:', obstaclesError)
      return NextResponse.json(
    ...
    console.error('Seasonal windows POST error:', error)
    return NextResponse.json(
